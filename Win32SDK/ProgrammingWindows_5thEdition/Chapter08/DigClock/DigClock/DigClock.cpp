...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd){
    static wchar_t szAppName[] = L"DigClock";
    HWND hwnd;
    MSG msg;
    WNDCLASS wndcls;
    ...
    hwnd = CreateWindowW(szAppName,L"Digital Clock",WS_OVERLAPPEDWINDOW,
...
void DisplayDigit(HDC hdc,int iNumber){
    ...
    int iSeg;
    for(iSeg=0;iSeg<7;++iSeg)if(fSevenSegment[iNumber][iSeg])
