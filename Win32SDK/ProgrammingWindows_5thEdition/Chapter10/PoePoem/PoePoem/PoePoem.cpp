...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow){
    ...
    if (!RegisterClass(&wndclass)){
        LoadString(hInstance, IDS_APPNAME, (wchar_t*)szAppName, sizeof(szAppName));
        LoadString(hInstance, IDS_ERRMSG, (wchar_t*)szErrMsg, sizeof(szErrMsg));

        MessageBox(NULL, (wchar_t*)szErrMsg, (wchar_t*)szAppName, MB_ICONERROR);
        return 0;
    }
    ...
    switch(message){
        case WM_CREATE:
            ...
            hResource = LoadResource(hInst,
                FindResource(hInst, MAKEINTRESOURCE(ANNABELLEE), TEXT("TEXT")));

            pText = (wchar_t*)LockResource(hResource);
            iNumLines = 0;
